...
* `variantToApplicationId`:  `variantName: "appId" map between your variant and application ID, will let you update apps with identical package names to a specific application.`
